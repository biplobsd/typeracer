# Login
loginButton = "//a[text()='Sign In' and @class='gwt-Anchor']"
...
offcanasToggle = '//td[@id="offcanvas-toggle"]'
...
textCopyButton = '//span[@class="Icon Icon_size_s Icon_type_copy-outline Icon_tone_black Button2-Icon"]/..'
textBox = '//div[@class="CbirOcr-Text"]'
clipboardPaste = '//span[text()="Paste from clipboard"]/..'
